// src/main/java/com/example/examenes/controller/QuestionController.java
...
public class PreguntasController {
    ...
    public String saveQuestion(@Valid @ModelAttribute("question") Question question,
        ...
        if (question.getType() == QuestionType.SINGLE_CHOICE || question.getType() == QuestionType.TRUE_FALSE) {
            ...
            if (correctCount != 1) {
                ...
                logger.warn("La pregunta '{}' tiene {} opciones correctas, se requiere exactamente una.", question.getText(), correctCount);
            }
        }
    ...
    // Procesar la actualización de una pregunta existente
